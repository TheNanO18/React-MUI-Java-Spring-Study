...
public class DBConn {
    ...
    private String employeeNumber; // snake_case -> camelCase로 변경

    private String userName;      // snake_case -> camelCase로 변경
    private String userId;        // snake_case -> camelCase로 변경
    private String password;
    private String phoneNumber;   // snake_case -> camelCase로 변경
    private String residentNumber; // snake_case -> camelCase로 변경
    private String mobileCarrier; // snake_case -> camelCase로 변경
